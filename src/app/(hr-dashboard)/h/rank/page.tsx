  ...
  return (
    <div className="h-85% w-full flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-950 my-12">
      ...
      <div className="flex-1 overflow-y-auto px-4 md:px-6 py-4">
          ...
          <div className="bg-white dark:bg-gray-900 p-4 rounded-xl shadow-sm border border-purple-100 dark:border-purple-900/20">
            <div className="flex items-center">
              <div className="p-2 bg-purple-100 dark:bg-purple-900/20 rounded-lg">
                <UserRound className="h-5 w-5 md:h-6 md:w-6 text-purple-600 dark:text-purple-400" />
              </div>
              <div className="ml-3">
        ...
        <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-xl shadow-md border border-purple-100 dark:border-purple-900/20 mb-6">
        ...
        {/* Candidates List */}
        <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-xl shadow-md border border-purple-100 dark:border-purple-900/20 mb-6">
          <h2 className="text-base font-semibold mb-4 md:mb-6 text-gray-800 dark:text-gray-200 flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
          <div className="lg:col-span-2 bg-white dark:bg-gray-900 p-4 md:p-6 rounded-xl shadow-md border border-green-100 dark:border-green-900/20">
          ...
          <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-xl shadow-md border border-purple-100 dark:border-purple-900/20">
            <h2 className="text-base font-semibold mb-4 text-gray-800 dark:text-gray-200 flex items-center">
              <span className="w-1 h-5 bg-purple-500 rounded-full mr-3 inline-block"></span>
              Top 5 Candidates
            </h2>
