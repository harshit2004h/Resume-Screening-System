        ...
        <div className="form-box login">
          <form action="#">
            ...
            <LoginLink
              authUrlParams={{
                connection_id:
                  process.env.KINDE_CONNECTION_PASSWORDLESS_EMAIL || "",
                login_hint: email,
              }}
            >
            ...
            <div className="social-icons">
              ...
              <LoginLink
                authUrlParams={{
                  connection_id: process.env.KINDE_CONNECTION_APPLE || "",
                }}
              >
                <Image
                  src={"/apple-brands.svg"}
                  width="15"
                  height="15"
                  alt="apple"
                  className="dark:invert"
              ...
              <LoginLink
                authUrlParams={{
                  connection_id: process.env.KINDE_CONNECTION_LINKEDIN || "",
                }}
              >
                <Image
